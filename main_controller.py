...
def print_outline_for_all_angles():
   titles = ['Rotated 30 Degrees','Rotated 45 Degrees','Rotated 60 Degrees','Rotated 90 Degrees','Rotated 180 Degrees','Rotated 360 Degrees']
   images = [result_values_file.image_1,result_values_file.image_2,result_values_file.image_3,result_values_file.image_4,result_values_file.image_5,result_values_file.image_6]
   for i in xrange(6):
