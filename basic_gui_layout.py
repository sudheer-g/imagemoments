...
def main_window():
    ...
    zernike_moment_description.set("Zernike moments are used to describe the shape of an object; however, since the Zernike polynomials are orthogonal to each other, there is no redundancy of information between the moments.")
...
def image_description_window():
    ...
    buttons_frame.pack(side=BOTTOM)
    rotate_image_button = Button(buttons_frame, text="Rotate Image", command = main_controller.print_outline_for_all_angles)
